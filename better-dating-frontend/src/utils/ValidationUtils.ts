...
const maxLength = (maxLength: number) => (value: string) => (value.length > maxLength ? Messages.maxLength(maxLength) : undefined);
...
export const validateExplanationComment = composeValidators(required, maxLength(255));
