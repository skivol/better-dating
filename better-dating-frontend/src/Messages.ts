export const readyForOfflineUsage =
  "Сайт загружен и будет частично работать без доступа к сети Интернет";
export const appUpdatedAndWillBeRefreshedOnNextVisit =
  "Новая версия загружена и будет доступна после закрытия текущей страницы и последующем её открытии";
