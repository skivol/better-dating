...
так как не знание не освобождает от последствий.
...
* изучение материалов на эту тему (есть ряд YouTube каналов, Reddit сообщества предоставляющие качественную информацию, а также форумы и сайты, например, [АнтиО](https://antio.ru) и [ПОРНОГРАФИЯ - ОРУЖИЕ ГЕНОЦИДА!](https://www.pravdu.info/зло/оружия-геноцида-ii/порнография-оружие/));
