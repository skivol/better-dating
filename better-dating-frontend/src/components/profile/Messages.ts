...
Есть еще система изложенная Питером Кэлдером в книге _"Око возрождения"_ содержащая описание 5 ритуалов-упражнений (о которой, правда, есть разные мнения, например, [Око Возрождения - польза или вред?](https://proza.ru/2015/11/25/837), [Око возрождения. Дополнительная информация.](https://yazivu.ru/energeticheskie-praktiki/oko-vozrozhdeniya-dopolnitelnaya-informaciya) и прочие).
Хотя она и состоит из разнообразных (с точки зрения прорабатываемых мышц/систем) упражнений-ритуалов, для большинства из них можно найти более эффективные аналоги, например, в выше упомянутой "Тренировочной Зоне" без дополнительного ритуального смысла.
`;
