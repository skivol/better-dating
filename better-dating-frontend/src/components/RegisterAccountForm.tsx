...
import {
  ...
  defaultValues as registrationDataDefaults,
...
export const RegisterAccountForm = () => {
  ...
  return (
    // validateOnBlur doesn't seem to properly work (for example, email field)...
    <Form
      key={formKey}
      ...
      render={({ handleSubmit }) => {
        ...
        const hasData =
          storedData.acceptTerms ||
          storedData.personalHealthEvaluation !== -1 ||
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <Grid item>
                <Paper
                  elevation={3}
                  className="u-max-width-450px u-padding-16px u-center-horizontally"
                >
                  <Field
                    name="acceptTerms"
