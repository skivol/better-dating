              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  <Grid container justify="center" alignItems="center">
                    ...
                    >
                      <Typography>{Messages.enterUsingEmail}</Typography>
                    </Button>
                    <Link
                      href={{
                        pathname: toPage(registerAccount),
                    ...
                    >
                      ...
                      >
                        <Typography>{Messages.register}</Typography>
                      </Button>
                    </Link>
                  </Grid>
                  ...
                  <Grid container justify="center" alignItems="center">
                    ...
                    >
                      <Typography>{Messages.enterUsingFacebook}</Typography>
                    </Button>
                    <Button
                      className={classes.button}
                    ...
                    >
                      <Typography>{Messages.enterUsingVk}</Typography>
                    </Button>
                  </Grid>
                </Paper>
              </form>
