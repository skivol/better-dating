...
export const libraries = [{
    ...
    url: 'https://github.com/spring-projects-experimental/spring-security-kotlin-dsl',
    license: Licenses.APACHE,
    copyright: null
}, {
    name: 'Spring Session',
...
export const infrastructure = [{
    ...
    copyright: ['Portions Copyright © 1996-2020, The PostgreSQL Global Development Group', 'Portions Copyright © 1994, The Regents of the University of California']
}, {
    name: 'Redis',
    ...
    copyright: ['Copyright (C) 2002-2020 Igor Sysoev', 'Copyright (C) 2011-2020 Nginx, Inc.']
}, {
    name: 'Docker CE',
