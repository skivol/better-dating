...
import { getData, unauthorized, showError, showSuccess, postData } from '../utils';
    ...
    React.useEffect(() => {
        getData('/api/admin/usage-stats')
            ...
            .catch((e) => {
                ...
                const message = isUnauthorized ? Messages.unauthorized : ActionMessages.oopsSomethingWentWrong;
        ...
        <>
            ...
            <div className="u-max-content u-center-horizontally">
                <Button
                    ...
                    disabled={sending}
                    startIcon={sending ? <SpinnerAdornment /> : <FontAwesomeIcon icon={faMailBulk} />}
                >
                    {Messages.testEmail}
                </Button>
            </div>
